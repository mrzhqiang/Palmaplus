      ...
      layers = {
        ...
        navigate = { -- 导航图层参考样式设置
         ...
         renderer = {
            type = 'unique',
            key = {
              'navi_name', -- 动态导航默认使用这个字段区别动态导航走过的路段样式和剩下的路段样式
            },
            default = {
              ['2d'] = {
               style = 'linestring',
            ...
            styles = {
              ["dyna_remain"]=DYNA_REMAIN(),--剩余路线的参考样式
              ["dyna_pass"]=DYNA_PASS()--走过路线的参考样式
            }
         },
       },
      }
